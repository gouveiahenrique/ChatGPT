...
public class MessageGroupComponent extends JBPanel<MessageGroupComponent> implements NullableComponent {
    public final String conversationId = UUID.randomUUID().toString();
    ...
    private final MessageComponent tips =
            new MessageComponent("I'm here to help you as an assistant during your journey as a developer at Bees. I can help you with code reviews, code explanation, write unit tests and many other things.",false);
    ...
    public MessageGroupComponent(@NotNull Project project, boolean isChatGPT) {
        ...
        MessageGroupComponent component = this;
